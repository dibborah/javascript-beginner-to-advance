...
person[key] = "dibborah100@gmail.com"// Look here carefully // Here the key is not written inside Open close inverted comma(""/'') since we dont want to add key with this value ("dibborah100@gmail.com") inside person object but we want to add email key which is inside the const key variable so the commas were not used here
